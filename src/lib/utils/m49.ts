const M49_TO_ALPHA3: Record<string, string> = {
...
const ALPHA3_TO_M49 = Object.fromEntries(
  Object.entries(M49_TO_ALPHA3).map(([m49, alpha3]) => [alpha3, m49])
) as Record<string, string>;

export function getM49Code(alpha3: string): string | null {
  return ALPHA3_TO_M49[alpha3] ?? null;
}
